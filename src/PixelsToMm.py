...
class PixelsToMm:
    ...
    def calculate_real_distances(self, i, tempList):
        ...
        # Voor het berekenen van de hoogte in milimeters maakt de dikte van de
        # laser niet uit; hier is de b in de formule dus gewoon 0.
        a = 0.2
        b = 5
        hoek = 12
        ...
        for j in range(0, data_array.shape[0]):
            ...
            # pixel_hoogte ging eerst fout, dit is hoe het zou moeten. (zie
            # xyCalcsAfbeelding2.png)
